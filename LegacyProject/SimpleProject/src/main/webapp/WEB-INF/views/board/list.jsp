...
<body>
	...
	<div class="content">
		...
		<div class="innerOuter" style="padding: 5% 10%;">
			...
			<a class="btn btn-secondary" style="float: right;" href="boards/form">글쓰기</a> <br>
			</c:if>
			<br>
			...
			<div id="pagingArea">
				<ul class="pagination">
					<li class="page-item"><a class="page-link" onclick="location.href='boards?page=${map.pi.currentPage -1 }'">이전</a></li>
					...
					<li class="page-item"><a class="page-link" onclick="location.href='boards?page=${ map.pi.currentPage + 1}'">다음</a></li>
				</ul>
			</div>
